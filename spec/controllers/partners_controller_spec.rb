...
RSpec.describe PartnersController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested partner as @partner" do
      partner = Partner.create! valid_attributes
      get :show, params: {id: partner.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested partner as @partner" do
      partner = Partner.create! valid_attributes
      get :edit, params: {id: partner.to_param}, session: valid_session
      expect(assigns(:partner)).to eq(partner)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Partner" do
        expect {
          post :create, params: {partner: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved partner as @partner" do
        post :create, params: {partner: invalid_attributes}, session: valid_session
        expect(assigns(:partner)).to be_a_new(Partner)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested partner" do
        partner = Partner.create! valid_attributes
        put :update, params: {id: partner.to_param, partner: new_attributes}, session: valid_session
        partner.reload
      ...
      it "assigns the requested partner as @partner" do
        partner = Partner.create! valid_attributes
        put :update, params: {id: partner.to_param, partner: valid_attributes}, session: valid_session
        expect(assigns(:partner)).to eq(partner)
      end
    ...
    context "with invalid params" do
      it "assigns the partner as @partner" do
        partner = Partner.create! valid_attributes
        put :update, params: {id: partner.to_param, partner: invalid_attributes}, session: valid_session
        expect(assigns(:partner)).to eq(partner)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested partner" do
      partner = Partner.create! valid_attributes
      expect {
        delete :destroy, params: {id: partner.to_param}, session: valid_session
      }.to change(Partner, :count).by(-1)
    end
