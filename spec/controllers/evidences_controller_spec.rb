...
RSpec.describe EvidencesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested evidence as @evidence" do
      evidence = Evidence.create! valid_attributes
      get :show, params: {id: evidence.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested evidence as @evidence" do
      evidence = Evidence.create! valid_attributes
      get :edit, params: {id: evidence.to_param}, session: valid_session
      expect(assigns(:evidence)).to eq(evidence)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Evidence" do
        expect {
          post :create, params: {evidence: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved evidence as @evidence" do
        post :create, params: {evidence: invalid_attributes}, session: valid_session
        expect(assigns(:evidence)).to be_a_new(Evidence)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested evidence" do
        evidence = Evidence.create! valid_attributes
        put :update, params: {id: evidence.to_param, evidence: new_attributes}, session: valid_session
        evidence.reload
      ...
      it "assigns the requested evidence as @evidence" do
        evidence = Evidence.create! valid_attributes
        put :update, params: {id: evidence.to_param, evidence: valid_attributes}, session: valid_session
        expect(assigns(:evidence)).to eq(evidence)
      end
    ...
    context "with invalid params" do
      it "assigns the evidence as @evidence" do
        evidence = Evidence.create! valid_attributes
        put :update, params: {id: evidence.to_param, evidence: invalid_attributes}, session: valid_session
        expect(assigns(:evidence)).to eq(evidence)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested evidence" do
      evidence = Evidence.create! valid_attributes
      expect {
        delete :destroy, params: {id: evidence.to_param}, session: valid_session
      }.to change(Evidence, :count).by(-1)
    end
